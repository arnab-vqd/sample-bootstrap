    ...
    <div className="container">
      ...
      <div className="row">
        <div className="col-md-4 text-center pad-top">
          <div>
            <div className="card">
              <Nav.Link href="#"><img className="card-img-top"  src="assets/blog-1.jpg"
              ...
              <div className="card-body pxy-48">
                ...
                <ul className="li-inline-cs  list-style-none  p-0">
                  <li><Nav.Link href="#" className="text-secondary "><i className="fa fa-calendar font-14  gry-clr"></i><span className="ml-7 font-12">Jan 14</span></Nav.Link></li>
                  <li><Nav.Link href="#" className="text-secondary "> <i className="fa fa-user font-14  gry-clr"></i><span className="ml-7 font-12">Peter</span></Nav.Link></li>
                  <li><Nav.Link href="#" className="text-secondary p-0"><i className="fa fa-comment font-14  gry-clr"></i><span className=" font-12 ml-7">7</span></Nav.Link></li>
                </ul>
...
<p className=" text-secondary text-start font-14">Lorem Ipsum is simply dummy text of the printing industry. Lorem has been dummy text ever since the 1500s...</p>
        ...
        <div className="col-md-4 text-center pad-top">
          <div>
            <div className="card">
              <video width="412" height="200" controls>
